...
namespace Modules\ModulePolishLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModulePolishLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * PolishLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class PolishLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-polish-language-pack';
