...
namespace Modules\ModulePolishLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Polish Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Polish UI translations from Messages/pl/ directory
 * - Polish voice prompts from Sounds/pl-pl/ directory
 *
 ...
 *
 * @package Modules\ModulePolishLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModulePolishLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Polish packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Polish Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Polish Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Polish Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Polish Language Pack uninstalled successfully',
            LOG_INFO
        );
